...
module Bosh::Director
  class CloudFactory
    ...
    def all_clouds
      clouds = all_from_cpi_config

      clouds.unshift({name: '', cpi: default_from_director_config }) if all_from_cpi_config.none? {|cloud| cloud[:cpi] == default_from_director_config}
